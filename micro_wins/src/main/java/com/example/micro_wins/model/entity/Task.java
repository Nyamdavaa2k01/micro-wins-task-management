...
public class Task {
    ...
    public Task(int taskId, String taskTitle, String taskDefinition, int taskPriority, int taskStatus, int taskCategory, Date taskStartDate, Date taskDeadline, int taskUserId) {
        this.taskId = taskId;
        this.taskTitle = taskTitle;
